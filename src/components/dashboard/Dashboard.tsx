...
const inspirationalQuotes = [
  ...
  {
    quote: "Success is not just about climbing the ladder, but also about maintaining your well-being while you climb.",
    author: "MindBFF"
  },
  {
  ...
  {
    quote: "Every small step you take is a step towards healing.",
    author: "MindBFF"
  },
  {
    quote: "Work-life balance is not about dividing your time equally. It's about finding harmony between your professional and personal life.",
    author: "MindBFF"
  },
  {
    quote: "Your worth is not measured by your productivity. Take care of yourself first.",
    author: "MindBFF"
  }
];
...
export default function Dashboard({ userProfile: propUserProfile, onStartProfileSetup }: DashboardProps) {
  ...
  const fetchPeopleSupported = async (userId: string) => {
    try {
      // Count accepted support requests where the user is the receiver (they provided support)
      // This means someone sent them a request and they accepted it
      ...
      try {
        ...
        if (user) {
          ...
          if (error) {
            ...
            if (profile.support_type === 'support-giver' || profile.support_type === 'I want to be there for others') {
...
<div className="grid grid-cols-2 gap-4">
    {/* Progress Section */}
    <div className="bg-[#ffe4e6] p-5 rounded-3xl shadow-sm">
        ...
        {isAuthenticated && (
            <>
                {isSupportGiver ? (
                    <>
                        <h2 className="text-2xl font-bold text-gray-900 mb-4">Support Impact</h2>
                    ...
                    >
                       <h2 className="text-2xl font-bold text-gray-900">Celebrate</h2>
                       <div className="relative h-24 overflow-hidden bg-white bg-opacity-40 rounded-lg p-3 flex-grow flex items-center justify-center">
                           {userStrengths.length > 0 ? (
                               ...
                               <div className="text-center text-gray-600 italic">
                                   Add strengths for daily reminders
                               </div>
                           )}
                       </div>
    ...
    <div className="bg-[#ffe4e6] p-5 rounded-3xl shadow-sm flex flex-col">
        <h2 className="text-2xl font-bold text-gray-900 mb-4">InstaCalm</h2>
        <div className="flex-grow flex items-center justify-center">
            <div 
                className="relative rounded-full bg-primary cursor-pointer transition-all duration-1000 flex items-center justify-center text-white"
                style={{ 
        ...
        <div>
          <h2 className="text-2xl font-bold text-gray-900 mb-4">Here's your calm corner</h2>
          <div className="grid grid-cols-2 gap-4">
            ...
            <div 
              ...
              className="bg-[#ede9fe] p-3 rounded-3xl shadow-sm hover:shadow-md transition-shadow cursor-pointer relative relative border-2 border-[#ddd6fe]"
            >
              {/* Highlight indicator 
              ...
              <div className="flex items-start">
                ...
                <span className="material-icons text-3xl mr-2 text-purple-500">people</span>
                <div>
                  <h2 className="font-semibold text-gray-900">2AM Circle</h2>
                  <p className="text-sm text-gray-600 mt-1">A secure place to share with people who get you</p>
                </div>
            ...
            <div 
              ...
              className="bg-[#ffe4e6] p-3 rounded-3xl shadow-sm hover:shadow-md transition-shadow cursor-pointer"
            >
              <div className="flex items-start">
                <span className="material-icons text-3xl mr-2 text-amber-600">self_improvement</span>
                <div>
                  <h2 className="font-semibold text-gray-900">ME Space</h2> 
                  <p className="text-sm text-gray-600 mt-1">Mind Essentials with reflection and meditation tools</p>
                </div>
              </div>
            </div>
          </div>
          ...
          {/* AI Companion */}
        <div className="flex justify-between items-center bg-[#ffe4e6] p-4 rounded-3xl shadow-sm">
          {/* AI Companion */}
          <div 
            onClick={() => handleFeatureClick(features[0])}
            className="flex flex-col items-center cursor-pointer hover:opacity-80 transition-opacity bg-white bg-opacity-50 rounded-2xl p-1 min-w-[90px]"
          >
            <span className="material-icons text-3xl text-teal-600 mb-2">assistant</span>
            <span className="text-xs font-medium text-gray-700 text-center">AI buddy</span>
          </div>
          ...
          <div 
            ...
            className="flex flex-col items-center cursor-pointer hover:opacity-80 transition-opacity bg-white bg-opacity-50 rounded-2xl p-1 min-w-[90px]"
          >
            <span className="material-icons text-3xl text-purple-600 mb-2">menu_book</span>
            <span className="text-xs font-medium text-gray-700 text-center">Journal</span>
          </div>
          ...
          <div 
            ...
            className="flex flex-col items-center cursor-pointer hover:opacity-80 transition-opacity bg-white bg-opacity-50 rounded-2xl p-1 min-w-[90px]"
          >
            <span className="material-icons text-3xl text-yellow-600 mb-2">timer</span>
            <span className="text-xs font-medium text-gray-700 text-center">Focus Timer</span>
          </div>
        </div>
        {/* Inspirational quote */}
        ...
        <div className="space-y-4">
          <div className="flex justify-between items-center mb-2">
            <h2 className="text-2xl font-bold text-gray-900">Resources Hub</h2>
            <Button
      ...
      {/* Strengths Modal */}
        ...
        {isAuthenticated && !showStrengthsModal && !showBlogModal && (
          <button
            className="fixed bottom-8 right-8 z-50 bg-blue-300 text-white rounded-full p-4 soft-shadow hover:bg-[#274472] transition-colors flex items-center justify-center"
            title="Send Feedback"
            ...
            <div className="bg-white rounded-2xl p-6 w-full max-w-md shadow-xl relative">
              ...
              <div className="flex flex-col items-center space-y-4">
                <a
                  ...
                  className="w-full bg-primary text-white rounded-full py-2 font-semibold hover:bg-[#274472] transition-colors text-center"
                >
                  Fill Feedback Form
                </a>

      ...
      <div className="max-w-2xl mx-auto space-y-8">
        ...
        >
          <h1 className="text-3xl font-bold text-gray-900">
            Which Experiences Relate to You?
          </h1>
          <p className="text-lg text-gray-600">
            Life has its ups and downs. We grow as we go through it, help us connect you with the right peers.
          </p>
        </motion.div>
        ...
        {hasSelection && (
          ...
          >
           <p className="text-gray-700 text-sm">
            <span className="material-icons mr-2 text-pink-500 text-xl">favorite</span>

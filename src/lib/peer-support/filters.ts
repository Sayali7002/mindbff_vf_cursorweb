...
export function mapSupportTypeToDatabase(uiType: string): string {
  if (uiType === "I want to vent out") return "support-seeker";
  if (uiType === "I want to be there for others") return "support-giver";
...
export function mapSupportTypeToUI(dbType: string): string {
  if (dbType === "support-seeker") return "I want to vent out";
  if (dbType === "support-giver") return "I want to be there for others";
  return dbType;
}
